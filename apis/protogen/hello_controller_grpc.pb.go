...
const (
	HelloController_SayHello_FullMethodName = "/protogen.HelloController/SayHello"
)
...
func (c *helloControllerClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedHelloControllerServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _HelloController_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloControllerServer).SayHello(ctx, req.(*HelloRequest))
	}
...
var HelloController_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protogen.HelloController",
	...
	Metadata: "apis/protogen/hello_controller.proto",
}
